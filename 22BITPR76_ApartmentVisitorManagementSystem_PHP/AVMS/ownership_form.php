          ...
          <div class="card shadow-sm rounded">
            ...
            <div class="card-body">
              <form class="needs-validation" method="post" action="form_action.php" novalidate>
                ...
                <div class="form-row mt-3">
                  <div class="col-md-3">
                    <label for="validationCustom01" class="f-w-600 f-18">Appartment Number</label>
                  </div>
                  <div class="col-md-9">
                    <input type="text" name="ownership_house_number" class="form-control" id="validationTooltip01" placeholder="Appartment Number" required="">
                ...
                <div class="form-row mt-3">
                  ...
                  <div class="col-md-9">
                    <input type="text" name="ownership_floor_wing" class="form-control" id="validationTooltip01" placeholder="Floor/Wing" required="">
                    <div class="invalid-feedback mb-3">Pleace Enter House Number</div>
                  </div>
                </div>
                <div class="form-row mt-3">
                  <div class="col-md-3">
                    <label for="validationCustom01" class="f-w-600 f-18">Appartment Ownership</label>
                  </div>
                  <div class="col-md-9">
            ...
            <div class="card-footer">
              <p style="text-align: center;" class="m-0 p-0">
                <button class="btn btn-outline-primary shadow-sm f-w-900 f-16" type="submit" name="submit_owner_form">Submit form</button>
              </p>
            </div>
            </form>
            <script>
