        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header py-2 shadow-sm rounded">
              <h3 class="text-center">Manage Visitors For Out</h3>
            </div>
          </div>
        </div>
      </div>
                ...
                <table class="table mb-0 table-striped table-dark rounded">
                  <thead>
                    <tr>
                      ...
                      <th class="bg-primary">Floor/wing</th>
                  ...
                  <tbody>
                    ...
                    $query = "SELECT * FROM `visitor_details` WHERE `out_remark` = 'NULL'";
                    $query;
                    ...
                    ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <!-- <a href="<?php echo 'form_action.php?delete_visitors_details=' . $data['id']; ?>" class="btn btn-outline-danger m-r-5 shadow-sm f-w-900 f-14">Delete</a>
                            <a href="manage_visitors.php" class="btn btn-outline-warning m-r-5 shadow-sm f-w-900 f-14">Update</a> -->
                          </td>
                        </tr>
                    <?php
                        $number++;
